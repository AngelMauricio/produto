...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        {{ \Form::open(['method' => 'POST', 'route' => ['produto.store'], 'enctype' => 'multipart/form-data']) }}
            <label>Nome</label><br>
            <input type="text" name="produto_nome"><br><br>

            <label>Preço</label><br>
            <input type="text" name="produto_preco" class="money"><br><br>

            <label>Descricao</label><br>
            <textarea name="produto_descricao" maxlength="255"></textarea><br><br>
